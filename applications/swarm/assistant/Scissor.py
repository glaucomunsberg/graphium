...
class Scissor:
    ...
    def cut_to_fit(self, destiny_path=None):
        ...
        max_width   = int(self._g.scissor['target_max_width'])
        max_height  = int(self._g.scissor['target_max_height'])
        rate        = float(self._g.scissor['target_rate'])
        min_width   = int(self._g.scissor['target_min_width'])
        min_height  = int(self._g.scissor['target_min_height'])
        ...
        if need_cut or need_rate:
            ...
            return "{0}{1}-{2}x{3}_resized.{4}".format(destiny_path, self.image_name, self.image.width, self.image.height, self.image.format.lower())
            ...
            return "{0}{1}-{2}x{3}_original.{4}".format(destiny_path, self.image_name, self.image.width, self.image.height, self.image.format.lower())
        else:
